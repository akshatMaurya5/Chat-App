  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <Text fontSize="3xl" fontFamily="Work sans bold" fontWeight='bold' color="purple.100" >
          Tech Talk
        </Text>
        ...
        <div>
          <Menu>
            <MenuButton p={1}>
              <NotificationBadge
                ...
                effect={Effect.SCALE}
              />
              <BellIcon fontSize="2xl" m={1} color="pink.50"/>
            </MenuButton>
            <MenuList pl={2}>
          ...
          <Menu>
            <MenuButton as={Button} bg="blue.700"  rightIcon={<ChevronDownIcon/>}  
              _hover={{background: "purple.800", color:"purple.100"}} _active={{background: "purple.800", color:"gray.400"}}>
              <Avatar size="sm" cursor="pointer" name={user.name} borderColor="black" borderWidth="2px" bg="gray.400" color="black"/>
            </MenuButton>
            <MenuList bg = "purple.600" borderColor="black" borderWidth="2px">
              <ProfileModal user={user}>
                <MenuItem fontWeight="bold" color="black" _hover={{background: "blue.100"}}  >
                  My Profile
                </MenuItem>{" "}
              </ProfileModal>
              <MenuDivider/>
              <MenuItem fontWeight="bold" color="black" onClick={logoutHandler} _hover={{background: "blue.100"}}>
                Logout
              </MenuItem>
            </MenuList>
          </Menu>
